<template>
    <div class="foot">
        ...
        <div class="guide_item" @click="gotoAddress({name: 'Msite', query: {geohash}})">
            <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="msiteActive? '#msiteActive' : '#msite'"></use>
            </svg>
            <span>外卖</span>
        </div>
        <div class="guide_item" @click="gotoAddress({name: 'Search', query: {geohash}})">
            <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="findActive? '#findActive' : '#find'"></use>
            </svg>
            <span>搜索</span>
        </div>
        <div class="guide_item" @click="gotoAddress({name: 'Order', query: {geohash}})">
            <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="orderActive? '#orderActive' : '#order'"></use>
            </svg>
            <span>订单</span>
        </div>
        <div class="guide_item" @click="gotoAddress({name: 'My', query: {geohash}})">
            <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="profileActive? '#profileActive' : '#profile'"></use>
            </svg>
            <span>我的</span>
        </div>
    </div>
...
export default {
  ...
  mounted () {
    ...
    if (url.indexOf('Msite') > 0) {
      this.msiteActive = true
    }
